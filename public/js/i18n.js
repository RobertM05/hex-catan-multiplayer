...
export const TRANSLATIONS = {
  en: {
    ...
    CARD_IRRIGATION_DESC: "Gain 2 wheat for each wheat hex adjacent to your buildings.",
    CARD_MEDICINE_DESC: "Your next city upgrade costs 2 ore and 1 wheat.",
    CARD_MINING_DESC: "Gain 2 ore for each ore hex adjacent to your buildings.",
    ...
    RULES_CK_COMMODITIES_BODY: "Cities on wool/ore/wheat produce 1 resource + 1 commodity (cloth/coin/paper). Cities on wood/brick produce 2 resources. Settlements never produce commodities. Commodities count toward the 7-card discard limit and can be traded, but cannot pay for buildings.",
    RULES_CK_COSTS_TITLE: "Building costs:",
    RULES_CK_COSTS_BODY: "Road = 1 Wood + 1 Brick. Settlement = 1 Wood + 1 Brick + 1 Wool + 1 Wheat (1 VP). City = 3 Ore + 2 Wheat (2 VP). Knight = 1 Ore + 1 Wool (placed inactive). Activate knight = 1 Wheat. Promote knight = 1 Wheat + 1 Ore. City wall = 2 Brick.",
    RULES_CK_KNIGHTS_TITLE: "Knights:",
    RULES_CK_KNIGHTS_BODY: "Supply per player: 2 Basic, 2 Strong, 1 Mighty. Politics 1 unlocks Strong; Politics 2 unlocks Mighty. Active knights defend against barbarians, can move, displace a weaker enemy knight, and chase the robber (then become inactive).",
    ...
    RULES_CK_IMPROVE_BODY: "Need a city to invest. Cost equals the level you reach (1–5) in cloth (Trade), coin (Politics), or paper (Science). Draw a progress card at level 3. Unique leader at level 4+ places a metropolis (+2 VP). Level 5 unlocks special perks: 2:1 bank trade (Trade), Mighty Knights (Politics), or Aqueduct resource perk (Science). Walls raise the discard threshold by 2 each (3 walls max).",
  ...
  ro: {
    ...
    SPAWN_AGENT_BTN: "🤖 Convoacă AI Agent",
    TOAST_AGENT_SUMMONED: "Agentul AI a fost convocat în cameră!",
    ...
    YOU_SUFFIX: "(Tu)",
    STATUS_YOUR_ROLL: "Tura ta: aruncă zarurile",
    STATUS_WAIT_ROLL: "Se așteaptă ca {name} să arunce zarurile",
    STATUS_YOUR_DISCARD: "Tura ta: decartează cărți",
    STATUS_WAIT_DISCARD: "Se așteaptă ca {name} să decarteze cărți",
    STATUS_YOUR_ROBBER: "Tura ta: mută hoțul",
    STATUS_WAIT_ROBBER: "Se așteaptă ca {name} să mute hoțul",
    STATUS_YOUR_ACTION: "Tura ta: alege acțiunile",
    STATUS_WAIT_ACTION: "Se așteaptă ca {name} să-și termine tura",
    STATUS_YOUR_SETUP: "Tura ta: plasează o așezare sau un drum",
    STATUS_WAIT_SETUP: "Se așteaptă ca {name} să plaseze o așezare sau un drum",
    STATUS_YOUR_SETUP_CK: "Tura ta: plasează un oraș sau un drum",
    STATUS_WAIT_SETUP_CK: "Se așteaptă ca {name} să plaseze un oraș sau un drum",
    STATUS_YOUR_BARBARIAN: "Tura ta: rezolvă invazia barbarilor",
    STATUS_WAIT_BARBARIAN: "Se așteaptă ca {name} să rezolve invazia barbarilor",
    STATUS_GAME_OVER: "Jocul s-a încheiat",
    STATUS_WAIT_GENERIC: "Se așteaptă pe {name}",
    OPP_STATE_ROLLING: "Aruncă zarurile",
    OPP_STATE_DISCARDING: "Decartează",
    OPP_STATE_ROBBER: "Mută hoțul",
    OPP_STATE_ACTING: "Acționează",
    OPP_STATE_WAITING: "Așteaptă",
    REASON_NOT_YOUR_TURN: "Nu este tura ta",
    REASON_NOT_ENOUGH_RESOURCES: "Nu ai suficiente resurse",
    REASON_ALREADY_ROLLED: "Ai aruncat deja zarurile",
    REASON_WRONG_PHASE: "Indisponibil în această fază",
    ...
    CARD_COMMERCIAL_HARBOR: "Port comercial",
    CARD_MASTER_MERCHANT: "Negustor-maestru",
    CARD_MERCHANT: "Negustor",
    CARD_MERCHANT_FLEET: "Flotă negustorească",
    CARD_RESOURCE_MONOPOLY: "Monopol pe resursă",
    CARD_BISHOP: "Episcop",
    CARD_CONSTITUTION: "Constituție",
    CARD_DESERTER: "Dezertor",
    CARD_DIPLOMAT: "Diplomat",
    CARD_INTRIGUE: "Intrigă",
    CARD_SABOTEUR: "Sabotor",
    CARD_WARLORD: "Războinic",
    CARD_ALCHEMIST: "Alchimist",
    CARD_CRANE: "Macara",
    CARD_ENGINEER: "Inginer",
    CARD_INVENTOR: "Inventator",
    CARD_IRRIGATION: "Irigație",
    CARD_MEDICINE: "Medicină",
    CARD_MINING: "Minerit",
    CARD_PRINTER: "Tipograf",
    CARD_SMITH: "Fierar",
    CARD_COMMERCIAL_HARBOR_DESC: "Obligă fiecare adversar să schimbe 1 marfă pe 1 resursă de-a ta.",
    CARD_MASTER_MERCHANT_DESC: "Vezi mâna unui adversar mai bogat și ia 2 cărți.",
    CARD_MERCHANT_DESC: "Pune negustorul pe un hex lângă așezarea sau orașul tău: schimb 2:1 și +1 PV.",
    CARD_MERCHANT_FLEET_DESC: "În această tură, schimbi orice resursă sau marfă 2:1 cu banca.",
    CARD_RESOURCE_MONOPOLY_DESC: "Alege o resursă. Fiecare adversar îți dă până la 2 cărți din acea resursă.",
    CARD_BISHOP_DESC: "Mută hoțul. Furi 1 carte de la fiecare jucător adiacent noului hex.",
    ...
    CARD_CRANE_DESC: "Următoarea îmbunătățire de oraș costă cu 1 marfă mai puțin.",
    CARD_ENGINEER_DESC: "Construiește un zid de oraș gratuit.",
    CARD_INVENTOR_DESC: "Schimbă două jetoane numerice. Nu poți atinge 2, 6, 8 sau 12.",
    CARD_IRRIGATION_DESC: "Primești 2 grâu pentru fiecare hex de grâu adiacent clădirilor tale.",
    CARD_MEDICINE_DESC: "Următoarea îmbunătățire la oraș costă 2 minereu și 1 grâu.",
    CARD_MINING_DESC: "Primești 2 minereu pentru fiecare hex de minereu adiacent clădirilor tale.",
    CARD_PRINTER_DESC: "+1 punct de victorie, dezvăluit imediat.",
    CARD_SMITH_DESC: "Promovează 2 cavaleri gratuit (rezerva rămâne necesară).",
    PROGRESS_CARDS_TITLE: "Cărți de progres ({count}/4)",
    PROGRESS_CARDS_AT_LIMIT: "Mână plină",
    PROGRESS_SPECIAL_TITLE: "Cărți speciale",
    DREW_PROGRESS_CARD: "Ai tras: {card}!",
    PROGRESS_DISCARD_TITLE: "Decartează o carte de progres",
    PROGRESS_DISCARD_HINT: "Ai mai mult de 4 cărți de progres nejucate. Decartează una ca să continui.",
    PROGRESS_SELECT_OPPONENT: "Alege un adversar",
    PROGRESS_SELECT_RESOURCE: "Alege o resursă",
    PROGRESS_SELECT_HEX: "Apasă un hex pe tablă",
    PROGRESS_SELECT_HEX_2: "Apasă un al doilea hex",
    PROGRESS_SELECT_KNIGHTS: "Apasă doi cavaleri ai tăi",
    PROGRESS_SELECT_KNIGHT: "Apasă un cavaler adversar",
    ...
    RULES_CK_VP_TITLE: "Victorie:",
    RULES_CK_VP_BODY: "Primul la 13 PV câștigă. Cărțile de dezvoltare clasice și Cea mai mare armată nu se folosesc.",
    RULES_CK_COMMODITIES_TITLE: "Comodități:",
    RULES_CK_COMMODITIES_BODY: "Orașele pe lână/minereu/grâu produc 1 resursă + 1 comoditate (pânză/monedă/hârtie). Orașele pe lemn/cărămidă produc 2 resurse. Satele nu produc niciodată comodități. Comoditățile contează la pragul de 7 la discard și se pot tranzacționa, dar nu plătesc clădiri.",
    RULES_CK_COSTS_TITLE: "Costuri clădiri:",
    RULES_CK_COSTS_BODY: "Drum = 1 Lemn + 1 Cărămidă. Așezare = 1 Lemn + 1 Cărămidă + 1 Lână + 1 Grâu (1 PV). Oraș = 3 Minereu + 2 Grâu (2 PV). Cavaler = 1 Minereu + 1 Lână (inactiv). Activare cavaler = 1 Grâu. Promovare cavaler = 1 Grâu + 1 Minereu. Zid de oraș = 2 Cărămidă.",
    RULES_CK_KNIGHTS_TITLE: "Cavaleri:",
    RULES_CK_KNIGHTS_BODY: "Rezervă per jucător: 2 de bază, 2 puternici, 1 mighty. Politică 1 deblochează Strong; Politică 2 deblochează Mighty. Cavalerii activi apără de barbari, se pot muta, deplasează un cavaler inamic mai slab și alungă hoțul (apoi redevin inactivi).",
    RULES_CK_BARBARIANS_TITLE: "Zar de eveniment și barbari:",
    RULES_CK_BARBARIANS_BODY: "Fiecare aruncare folosește 2 zaruri de producție plus un zar de eveniment (3/6 barbar, 1/6 fiecare Comerț/Politică/Știință). Corabia avansează pe fața de barbar. La capătul pistei, dacă puterea cavalerilor activi este cel puțin numărul de orașe, Catan câștigă și apărătorul unic cel mai puternic primește Defender of Catan (+1 PV). Dacă Catan pierde, jucătorii cu cei mai puțini cavaleri activi care mai au oraș trebuie să retrogradeze unul. Apoi toți cavalerii redevin inactivi. O față colorată lasă fiecare jucător al cărui track corespunzător este cel puțin zarul roșu să tragă o carte de progres.",
    RULES_CK_IMPROVE_TITLE: "Îmbunătățiri de oraș:",
    RULES_CK_IMPROVE_BODY: "Ai nevoie de un oraș ca să investești. Costul este nivelul la care urci (1–5) în pânză (Comerț), monedă (Politică) sau hârtie (Știință). Tragi o carte de progres la nivelul 3. Liderul unic de la nivelul 4+ pune o metropolă pe un oraș (+2 PV). Nivelul 5 deblochează abilități speciale: schimb bancar 2:1 (Comerț), Cavaleri Mighty (Politică) sau Apeduct (Știință). Zidurile ridică pragul de discard cu 2 fiecare (maxim 3 ziduri).",
    RULES_CK_TITLES_TITLE: "Titluri speciale:",
    RULES_CK_TITLES_BODY: "Cel mai lung drum (minim 5 segmente continue) = +2 PV. Cărțile Defender of Catan = +1 PV fiecare. Nu există Cea mai mare armată.",
    RULES_CK_PROGRESS_TITLE: "Cărți de progres:",
    RULES_CK_PROGRESS_BODY: "Înlocuiesc cărțile de dezvoltare. Limită 4 cărți nejucate. Se joacă în tura ta (Alchimistul înainte să arunci zarurile).",
    ...
    ROAD_LENGTH_ABBR: "Drum",
    ARMY_SIZE_ABBR: "Armată",
    DEFENDER_ABBR: "Apărător",
    LONGEST_ROAD_TITLE: "Cel mai lung drum",
    LARGEST_ARMY_TITLE: "Cea mai mare armată",
    DEFENDER_TITLE: "Apărătorul Catanului",
    ...
    LOG_SETUP_CITY: "{playerName} a așezat un oraș.",
    ...
    LOG_ROBBER_MOVED: "{playerName} a mutat hoțul pe hexul {number}.",
    LOG_ROBBER_MOVED_DESERT: "{playerName} a mutat hoțul pe deșert.",
    ...
    LOG_PROGRESS_CARD_PLAYED: "{playerName} a jucat {card}.",
    ...
    LOG_CITY_WALL_BUILT: "{playerName} a construit un zid de oraș.",
    LOG_AQUEDUCT_RESOURCE: "{playerName} a colectat 1 {resource} prin Apeduct.",
    ...
    SETUP_HINT_CITY_2: "Faza de început 2/2: Așază orașul (primești resurse și comodități de start!)",
    ...
    ERROR_KNIGHT_CANNOT_ACT_ON_HIRED_TURN: "Cavalerul nu poate acționa în tura în care a fost recrutat.",
    ERROR_KNIGHT_ALREADY_ACTED_THIS_TURN: "Acest cavaler a acționat deja în această tură.",
    ERROR_AQUEDUCT_NOT_UNLOCKED: "Apeductul necesită nivelul 5 la Știință.",
