...
export const STRINGS = {
    ...
    RULES_CK_KNIGHTS_BODY: "Supply per player: 2 Basic, 2 Strong, 1 Mighty. Basic knights promote to Strong with no Politics requirement. Fortress (Politics 3) unlocks Mighty. Active knights defend against barbarians, can move, displace a weaker enemy knight, and chase the robber (then become inactive).",
