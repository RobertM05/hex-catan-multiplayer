...
export const STRINGS = {
    ...
    RULES_CK_IMPROVE_BODY: "Need a city to invest. Cost equals the level you reach (1–5) in cloth (Trade), coin (Politics), or paper (Science). Draw a progress card at level 3. Unique leader at level 4+ places a metropolis (+2 VP). Aqueduct (Science 3) lets you choose 1 resource when a production roll yields nothing. Level 5 unlocks special perks: 2:1 bank trade (Trade) or Mighty Knights (Politics). Walls raise the discard threshold by 2 each (3 walls max).",
