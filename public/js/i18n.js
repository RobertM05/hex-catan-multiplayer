...
export const STRINGS = {
    ...
    RULES_CK_KNIGHTS_BODY: "Supply per player: 2 Basic, 2 Strong, 2 Mighty. Politics 1 unlocks Strong; Politics 3 (Fortress) unlocks Mighty. Recruit then activate is legal the same turn; activating a knight (including Warlord) is its action for the turn. Promote is not an action. Active knights move along a continuous chain of your roads, displace a weaker enemy knight (who keeps active/inactive status and may enter the vacated intersection if roads connect), and chase the robber (then become inactive).",
    ...
    ERROR_POLITICS_LEVEL_TOO_LOW: "Politics improvement is too low to promote (Fortress / Politics 3 unlocks Mighty).",
