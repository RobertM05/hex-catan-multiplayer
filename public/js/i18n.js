...
export const STRINGS = {
    ...
    RANKED_QUEUE_TAB: "Ranked 4P",
    RANKED_TITLE: "4-Player Ranked Matchmaking",
    RANKED_DESC: "Compete in official 4-player matches with Elo rating. 1st & 2nd gain Elo, 3rd & 4th lose Elo. Early abandonment receives a 4th-place penalty.",
    RANKED_SIGN_IN_PROMPT: "Sign in required for Ranked",
    RANKED_SIGN_IN_REQUIRED: "Please sign in to play Ranked!",
    RANKED_SEARCHING: "Searching for 4 players...",
    RANKED_MATCH_FOUND: "⚔️ Ranked Match Found! Starting game...",
    SIGN_IN: "Sign in",
    SIGN_OUT: "Sign out",
    SIGN_IN_GOOGLE: "Continue with Google",
    SIGN_IN_MAGIC: "Email magic link",
    SIGN_IN_EMAIL_PLACEHOLDER: "you@example.com",
    SIGN_IN_HINT: "Optional. Guests can host and join without an account.",
    ...
    MY_STATS: "My stats",
    STATS_TITLE: "Match history",
    STATS_EMPTY: "No matches recorded yet. Finish a game while signed in.",
    STATS_MATCHES: "Matches",
    STATS_WINS: "Wins",
    STATS_AVG_RANK: "Average finish",
    STATS_AVG_VP: "Average VP",
    STATS_BACK: "Back to lobby",
    STATS_GUEST: "Sign in from the lobby to see your stats.",
    STATS_RANK: "Finish #{rank}",
