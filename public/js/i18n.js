...
export const TRANSLATIONS = {
  en: {
    ...
    STATUS_YOUR_METROPOLIS: "Your turn: choose a city for the metropolis",
    STATUS_WAIT_METROPOLIS: "Waiting for {name} to place a metropolis",
    STATUS_YOUR_KNIGHT_RELOCATE: "Your turn: relocate a displaced knight",
    STATUS_WAIT_KNIGHT_RELOCATE: "Waiting for {name} to relocate a knight",
    ...
    CARD_DESERTER_DESC: "Remove an opponent knight from the board. It returns to their supply.",
    CARD_DIPLOMAT_DESC: "Remove an open road. If it is yours, you may rebuild it for free.",
    CARD_INTRIGUE_DESC: "Displace an opponent knight adjacent to one of your vertices.",
    ...
    ACTION_HINT_BUILD_WALL: "Click one of your cities to attach a city wall",
    ACTION_HINT_METROPOLIS: "Click one of your cities to make it a metropolis",
    BUILD_CITY_WALL: "Wall",
    BUILD_CITY_WALL_COST: "2 Brick",
    PLACE_KNIGHT: "Knight",
  ...
  ro: {
    ...
    STATUS_YOUR_METROPOLIS: "Tura ta: alege un oraș pentru metropolă",
    STATUS_WAIT_METROPOLIS: "Se așteaptă ca {name} să plaseze metropola",
    STATUS_YOUR_KNIGHT_RELOCATE: "Tura ta: relochează cavalerul alungat",
    STATUS_WAIT_KNIGHT_RELOCATE: "Se așteaptă ca {name} să relocheze cavalerul",
    ...
    CARD_DESERTER_DESC: "Scoate un cavaler adversar de pe tablă. Revine în rezerva lui.",
    CARD_DIPLOMAT_DESC: "Scoate un drum deschis. Dacă e al tău, îl poți reconstrui gratuit.",
    CARD_INTRIGUE_DESC: "Dislocă un cavaler adversar adiacent unuia dintre vârfurile tale.",
    ...
    ACTION_HINT_BUILD_WALL: "Apasă pe un oraș propriu pentru a construi un zid",
    ACTION_HINT_METROPOLIS: "Apasă pe un oraș propriu pentru a-l face metropolă",
    BUILD_CITY_WALL: "Zid",
    BUILD_CITY_WALL_COST: "2 Cărămidă",
