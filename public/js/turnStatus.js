...
export function mapPhaseToStatusKey(phase, isMyTurn) {
  switch (phase) {
    ...
    case 'TURN_CHOOSE_METROPOLIS':
      return isMyTurn ? 'STATUS_YOUR_METROPOLIS' : 'STATUS_WAIT_METROPOLIS';
    case 'TURN_CHOOSE_KNIGHT_RELOCATE':
      return isMyTurn ? 'STATUS_YOUR_KNIGHT_RELOCATE' : 'STATUS_WAIT_KNIGHT_RELOCATE';
    case 'GAME_OVER':
